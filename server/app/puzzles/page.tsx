...
export default function PuzzlesPage() {
  ...
  return <section className="community">
    <h1>Community nonograms</h1>
    <div className="tabs"><a href="/puzzles">All sizes</a><a href="/puzzles?size=5">Tiny</a><a href="/puzzles?size=10">Small</a><a href="/puzzles?size=15">Medium</a></div>
